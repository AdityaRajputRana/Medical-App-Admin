...
//
//public class CaseDetailsActivityArchieve extends AppCompatActivity {
//
...
//            downloadCase(caseId);
//        }
//        manager = new GridLayoutManager(CaseDetailsActivityArchieve.this, 2);
//
...
//        APIMethods.viewCase(CaseDetailsActivityArchieve.this, caseId, new APIResponseListener<ViewCaseRP>() {
//            @Override
...
//
//        binding.rcvAdditionals.setAdapter(new AdditionalsRVAdapter(additionalsList, CaseDetailsActivityArchieve.this, new AdditionalsRVAdapter.AdditionItemListener() {
//            @Override
...
//        Toast.makeText(CaseDetailsActivityArchieve.this, "Loading video. Please wait...", Toast.LENGTH_SHORT).show();
//        if(metaData.getMime().equals("link/youtube")){
//            YTVideoPlayer ytVideoPlayer = new YTVideoPlayer(CaseDetailsActivityArchieve.this);
//            Log.i(TAG, "onLinkGuideClicked: url "+url );
//            ytVideoPlayer.playVideo(url);
//        } else {
//            WebVideoPlayer webVideoPlayer = new WebVideoPlayer(CaseDetailsActivityArchieve.this);
...
//
////
//        AudioPlayer player = new AudioPlayer(CaseDetailsActivityArchieve.this);
...
//        if (adapter == null) {
//            adapter = new PagesHistoryAdapter(response, CaseDetailsActivityArchieve.this, new PagesHistoryAdapter.PageListener() {
//                @Override
//                public void onPageClicked(ArrayList<Page> pages, int currentPosition) {
//                    Intent i = new Intent(CaseDetailsActivityArchieve.this,DetailedPageViewActivity.class);
